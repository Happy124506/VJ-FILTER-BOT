...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002096889733').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://lofiversion7:9jQLdeRWxVyGfnY7@cluster0.ezglaii.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://ipapkorn-udzb.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://ipapkorn-udzb.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://ipapkorn-udzb.onrender.com/".format(FQDN)
else:
    URL = "https://ipapkorn-udzb.onrender.com/".format(FQDN)
